# Packer template to create a vagrant box containing Nginx using VirtualBox

This repository contains a Packer template for building a vagrant box containing Nginx using VirtualBox
...
```
6. After testing, manually "release" the version in the [Vagrant Cloud website](https://app.vagrantup.com/)
...
```
$ vagrant init qwerty1979/nginx64
$ vagrant up
```
